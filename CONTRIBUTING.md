...
- **E6034 / W6034 (README `## License`):** the section must contain the **full MIT text** (≥ 100 words) **or** a markdown link whose URL contains **`LICENSE`** (e.g. `[LICENSE](./LICENSE)`). Keep **`## License` as the last `##` heading** (W6021).
