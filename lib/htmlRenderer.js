...
<p style="font-size:16px;color:#444;margin:12px 0 16px">${esc(i18n.t('onboardingIntro'))}</p>
${contactHtml}<div class="stat-grid">
...
`;
  ...
  ${profile === PROFILE_ADMIN ? `<td>${membersCell || '—'}</td>` : ''}
			...
			// 4.7: Admin device hierarchy (resolved names + OIDs) — each room collapsible
			if (profile === PROFILE_ADMIN) {
