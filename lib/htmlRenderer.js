 ...
 */
const RENDERER_VERSION = '2026.09.22.4';
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .maint-details-summary { cursor: pointer; font-size: 15px; font-weight: 600; color: var(--text); padding: 4px 0; user-select: none; list-style: none; display: flex; align-items: baseline; gap: 2px; }
  .maint-details-summary::-webkit-details-marker { display: none; }
  .maint-details-summary::before { content: '\\25B6\\00A0'; font-size: 10px; color: var(--disclosure-chevron); display: inline-block; transition: transform 0.15s ease, color 0.15s ease; flex-shrink: 0; }
...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:10px">\n`;
  ...
  <p class="adapter-desc">${esc(line)}</p>
	...
	renderUserAdaptersChapter(docModel) {
		...
		let html = `<details class="autodoc-collapsible-section" id="adapter-instances">
...
`;
	...
	_renderMermaidDiagramHtml(manualContext, docModel, profile) {
		...
		const i18n = this.i18n;
		return `<h3 id="mermaid-diagram">${esc(i18n.t('mermaidDiagramTitle'))}</h3>
<p style="font-size:13px;color:var(--text-muted);margin:8px 0 12px">${esc(i18n.t('mermaidDiagramIntro'))}</p>
...
<pre class="mermaid">${esc(raw)}</pre>
		...
		if (profile === PROFILE_ADMIN || profile === PROFILE_USER) {
			return `<details class="autodoc-collapsible-section" id="mermaid-diagram-auto">
