 ...
 */
const RENDERER_VERSION = '2026.09.22.3';
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .adapter-section-summary::before { content: '\\25B6'; font-size: 10px; color: var(--text-faint); transition: transform 0.15s; display: inline-block; }
  ...
  .aci-instances summary::before { content: '\\25B6\\00A0'; font-size: 9px; }
  .aci-instances[open] summary::before { content: '\\25BC\\00A0'; }
...
<p style="font-size:13px;color:var(--text-muted);margin:8px 0 12px">${esc(i18n.t('mermaidAutoTopologyIntro'))}</p>
<div class="mermaid-wrap">
<pre class="mermaid">${esc(raw)}</pre>
</div>\n`;
	}
