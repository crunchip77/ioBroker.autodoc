...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .adapter-section-summary { cursor: pointer; padding: 6px 0; user-select: none; list-style: none; font-weight: 600; font-size: 15px; color: var(--text); }
  .adapter-section-summary::-webkit-details-marker { display: none; }
  .adapter-section-summary .adapter-section-counts { font-size: 12px; font-weight: 400; color: var(--text-faint); margin-left: 8px; }
