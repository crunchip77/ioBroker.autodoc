 ...
 */
const RENDERER_VERSION = '2026.09.20.2';
...
`;
		if (overview.eventScriptCount > 0) {
			html += `<p style="font-size:13px;color:var(--text-muted);margin:12px 0"><a href="#scripts">${esc(i18n.t('automationOverviewEventHint').replace('{0}', overview.eventScriptCount))}</a></p>\n`;
		}
