...
<dl class="meta">
  <dt>${esc(i18n.t('troubleshootLogsLabel'))}</dt><dd>${esc(i18n.t('troubleshootLogsValue'))}</dd>
  <dt>${esc(i18n.t('troubleshootObjectsLabel'))}</dt><dd>${i18n.t('troubleshootObjectsValue', system.primaryHost.name)}</dd>
</dl>
`;
