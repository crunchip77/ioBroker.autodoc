 ...
 */
const RENDERER_VERSION = '2026.04.11.6';
...
(function(){
  ...
  inp.addEventListener('input', function(){
    ...
    document.querySelectorAll('#userdata-list details').forEach(function(d){ d.open = !!term; });
  });
})();
</script>
<hr class="section-divider">
...
(function(){
  ...
  inp.addEventListener('input', function(){
    ...
    if (cnt) cnt.textContent = (term ? visible + ' / ' : '') + ${totalItems} + ' ${esc(i18n.t('totalSuffix') || 'gesamt')}';
    document.querySelectorAll('#alias-list details').forEach(function(d){ d.open = !!term; });
  });
})();
</script>
<hr class="section-divider">
