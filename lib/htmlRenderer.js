...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:10px">\n`;
  ...
  <div id="qrcode" style="display:none;background:#fff;padding:8px;border-radius:6px;border:1px solid var(--border);display:inline-block"></div>
  <div id="qr-copy-btn" style="margin-top:6px">
