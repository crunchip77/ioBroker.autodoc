 ...
 */
const RENDERER_VERSION = '2026.09.22.6';
...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:10px">\n`;
  ...
  <strong>${esc(fn.name)}</strong> <span style="color:var(--text-faint);font-size:12px">(${esc(fn.memberCount)})</span>
	...
	_renderFamilyAutomationsSummary(docModel, profile) {
		...
		let html = `<p style="font-size:14px;color:var(--text-faint);line-height:1.55;margin-bottom:12px">${esc(
	 ...
	 */
	_renderFamilyAutomationsTriggerMix(docModel) {
		const i18n = this.i18n;
		...
		return `<p style="font-size:13px;color:var(--text-muted);line-height:1.5;margin-bottom:12px">${esc(
