 ...
 */
const RENDERER_VERSION = '2026.04.07.02';
...
<div class="search-wrap">
  ...
  <div id="search-hint" style="font-size:11px;color:var(--text-faint);margin-top:3px;display:none">${esc(this.i18n.t('searchHint') || '↑↓ navigieren · Esc = löschen')}</div>
</div>
${nav}
...
(function () {
  ...
  searchInput.addEventListener('focus', function () { if (hint) hint.style.display = 'block'; });
  searchInput.addEventListener('blur', function () { if (hint && !searchInput.value) hint.style.display = 'none'; });
