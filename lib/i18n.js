...
const translations = {
	en: {
		...
		mermaidDiagramIntro:
			'Diagram from your documentation settings (Mermaid). In HTML it renders in the browser; Markdown contains the source for viewers that support Mermaid.',
	...
	de: {
		...
		mermaidDiagramIntro:
			'Diagramm aus den Dokumentations-Einstellungen (Mermaid). Im HTML wird es im Browser gerendert; im Markdown steht der Quelltext für Mermaid-fähige Viewer.',
	...
	fr: {
		...
		mermaidDiagramIntro:
			'Diagramme issu des paramètres de documentation (Mermaid). Dans le HTML il s’affiche dans le navigateur ; le Markdown contient la source pour les lecteurs compatibles Mermaid.',
