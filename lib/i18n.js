...
const translations = {
	en: {
		...
		stateReferencesDesc:
			'States referenced by scripts (static analysis of source). The description column is the script comment from the JavaScript adapter (same as in the script list above); “—” if empty — those scripts also count toward maintenance “scripts without description”.',
		script: 'Script',
		...
		aliasTarget: 'Target',
		scoreDesc:
			'The score shows how complete the documentation is: all scripts labelled + all instances active = 100%.',
		totalSuffix: 'total',
	...
	de: {
		...
		stateReferencesDesc:
			'Von Skripten referenzierte States (statische Analyse des Quelltexts). Spalte „Beschreibung“ = Skriptkommentar im JavaScript-Adapter (wie in der Skriptliste oben); „—“ wenn leer — diese Skripte fließen auch in die Wartung „Skripte ohne Beschreibung“ ein.',
		script: 'Skript',
		...
		aliasTarget: 'Ziel',
		scoreDesc:
			'Der Score zeigt wie vollständig die Dokumentation ist: alle Skripte beschriftet + alle Instanzen aktiv = 100 %.',
		totalSuffix: 'gesamt',
	...
	fr: {
		...
		stateReferencesDesc:
			'États référencés par des scripts (analyse statique du code). La colonne description reprend le commentaire du script dans l’adaptateur JavaScript (comme dans la liste des scripts) ; « — » si vide — ils comptent aussi dans la maintenance « scripts sans description ».',
		script: 'Script',
		...
		aliasTarget: 'Cible',
		scoreDesc:
			'Le score indique la complétude de la documentation : tous les scripts étiquetés + toutes les instances actives = 100 %.',
		totalSuffix: 'total',
