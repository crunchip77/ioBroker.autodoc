...
const translations = {
	en: {
		...
		allGood: 'No disabled adapter instances in this checklist.',
		checkOk: 'OK',
		...
		stateReferencesDesc:
			'States referenced by scripts (static analysis of source). The description column matches the script object field common.desc (JavaScript adapter), same as in the script list above; “—” if empty.',
		script: 'Script',
		...
		aliasTarget: 'Target',
		scoreDesc:
			'The score reflects disabled adapter instances only: none disabled = 100%. Script descriptions (common.desc) are optional and listed separately.',
		totalSuffix: 'total',
	...
	de: {
		...
		allGood: 'Keine deaktivierten Adapter-Instanzen in dieser Checkliste.',
		checkOk: 'OK',
		...
		stateReferencesDesc:
			'Von Skripten referenzierte States (statische Analyse des Quelltexts). Spalte „Beschreibung“ = common.desc am Skriptobjekt (JavaScript-Adapter), wie in der Skriptliste oben; „—“ wenn leer.',
		script: 'Skript',
		...
		aliasTarget: 'Ziel',
		scoreDesc:
			'Der Score bezieht sich nur auf deaktivierte Adapter-Instanzen: keine deaktiviert = 100 %. Skript-Beschreibungen (common.desc) sind optional und stehen separat.',
		totalSuffix: 'gesamt',
	...
	fr: {
		...
		allGood: 'Aucune instance d’adaptateur désactivée dans cette liste.',
		checkOk: 'OK',
		...
		stateReferencesDesc:
			'États référencés par des scripts (analyse statique du code). La colonne description reprend le champ common.desc de l’objet script (adaptateur JavaScript), comme dans la liste des scripts ; « — » si vide.',
		script: 'Script',
		...
		aliasTarget: 'Cible',
		scoreDesc:
			'Le score ne porte que sur les instances d’adaptateur désactivées : aucune = 100 %. Les descriptions de script (common.desc) sont optionnelles et listées à part.',
		totalSuffix: 'total',
