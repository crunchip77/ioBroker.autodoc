...
const translations = {
	en: {
		...
		automationOverviewIntro:
			'Combined view of JavaScript schedules/triggers, ioBroker schedule objects, and adapter CRON schedules — from data AutoDoc already reads. Details remain in the Scripts, Schedule objects, and Adapters chapters below.',
		automationOverviewEmpty:
			'No JavaScript schedules, schedule objects, or adapter CRON entries were found. Event-only scripts without a detectable trigger may still exist — see the Scripts chapter.',
		automationOverviewLimits:
			'Not included here: Blockly internals, Node-RED flows, scene/logic adapters AutoDoc does not connect to, and automations outside script.js / schedule objects / adapter CRON fields.',
		automationOverviewKind: 'Type',
		automationOverviewSource: 'Source',
		automationOverviewWhen: 'Schedule / trigger',
	...
	de: {
		...
		automationOverviewIntro:
			'Kombinierte Übersicht: JavaScript-Zeitpläne/Auslöser, ioBroker-Schedule-Objekte und Adapter-CRON — aus Daten, die AutoDoc ohnehin einliest. Details stehen in den Kapiteln Skripte, Schedule-Objekte und Adapter darunter.',
		automationOverviewEmpty:
			'Keine JavaScript-CRON-Einträge, Schedule-Objekte oder Adapter-CRON gefunden. Event-Skripte ohne erkennbaren Auslöser können trotzdem existieren — siehe Kapitel Skripte.',
		automationOverviewLimits:
			'Nicht enthalten: Blockly-Innereien, Node-RED-Flows, Szenen/Logik-Adapter ohne Anbindung sowie Automation außerhalb von script.js / Schedule-Objekten / Adapter-CRON-Feldern.',
		automationOverviewKind: 'Art',
		automationOverviewSource: 'Quelle',
		automationOverviewWhen: 'Zeitplan / Auslöser',
		automationOverviewStatus: 'Status',
		automationKindScriptCron: 'JavaScript (CRON)',
	...
	fr: {
		...
		automationOverviewIntro:
			'Vue combinée : plannings/déclencheurs JavaScript, objets schedule ioBroker et CRON d’adaptateur — à partir des données déjà lues par AutoDoc. Les détails restent dans les chapitres Scripts, Objets schedule et Adaptateurs ci-dessous.',
		automationOverviewEmpty:
			'Aucun CRON JavaScript, objet schedule ou CRON d’adaptateur trouvé. Des scripts événementiels sans déclencheur détecté peuvent exister — voir le chapitre Scripts.',
		automationOverviewLimits:
			'Non inclus : internals Blockly, flux Node-RED, adaptateurs scènes/logique non connectés, et automatisations hors script.js / objets schedule / champs CRON d’adaptateur.',
		automationOverviewKind: 'Type',
		automationOverviewSource: 'Source',
		automationOverviewWhen: 'Planning / déclencheur',
