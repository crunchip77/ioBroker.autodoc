...
const translations = {
	en: {
		...
		adapterNotResponding: 'Adapter not responding',
		troubleshootCheck1: 'Check adapter is enabled in the Adapters section above',
		troubleshootCheck2: host => `Verify the primary host <strong>${host}</strong> is running`,
		troubleshootCheck3: 'Check system resources (CPU, Memory, Disk Space)',
		stateObjectsNotUpdating: 'State Objects not updating',
		troubleshootState1: 'Verify the adapter instance is enabled',
		troubleshootState2: 'Check adapter configuration and logs',
		troubleshootState3: 'Look for any error messages in the ioBroker admin panel',
	...
	de: {
		...
		adapterNotResponding: 'Adapter antwortet nicht',
		troubleshootCheck1: 'Prüfen Sie ob der Adapter im Abschnitt Adapter oben aktiviert ist',
		troubleshootCheck2: host => `Überprüfen Sie ob der primäre Host <strong>${host}</strong> läuft`,
		troubleshootCheck3: 'Systemressourcen prüfen (CPU, Arbeitsspeicher, Festplatte)',
		stateObjectsNotUpdating: 'State-Objekte werden nicht aktualisiert',
		troubleshootState1: 'Überprüfen Sie ob die Adapter-Instanz aktiviert ist',
		troubleshootState2: 'Adapter-Konfiguration und Protokolle prüfen',
		troubleshootState3: 'Im ioBroker Admin-Panel nach Fehlermeldungen suchen',
		collectorStatus: 'Collector-Status',
	...
	fr: {
		...
		adapterNotResponding: "L'adaptateur ne répond pas",
		troubleshootCheck1: "Vérifiez que l'adaptateur est activé dans la section Adaptateurs ci-dessus",
		troubleshootCheck2: host => `Vérifiez que l'hôte principal <strong>${host}</strong> fonctionne`,
		troubleshootCheck3: 'Vérifiez les ressources système (CPU, mémoire, disque)',
		stateObjectsNotUpdating: "Les objets d'état ne se mettent pas à jour",
		troubleshootState1: "Vérifiez que l'instance de l'adaptateur est activée",
		troubleshootState2: "Vérifiez la configuration et les journaux de l'adaptateur",
		troubleshootState3: "Recherchez des messages d'erreur dans le panneau d'administration ioBroker",
