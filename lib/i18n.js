...
const translations = {
	en: {
		...
		troubleshootLogsLabel: 'Adapter logs',
		troubleshootLogsValue: 'ioBroker Admin → Log tab → filter by adapter name',
		troubleshootObjectsLabel: 'Adapter alive state',
		troubleshootObjectsValue: host => `Objects tab → system.adapter.*.0.alive (host: ${host})`,
	...
	de: {
		...
		troubleshootLogsLabel: 'Adapter-Logs',
		troubleshootLogsValue: 'ioBroker Admin → Reiter „Log" → nach Adapter-Name filtern',
		troubleshootObjectsLabel: 'Adapter-Status (alive)',
		troubleshootObjectsValue: host => `Objekte-Reiter → system.adapter.*.0.alive (Host: ${host})`,
		collectorStatus: 'Collector-Status',
	...
	fr: {
		...
		troubleshootLogsLabel: 'Journaux adaptateur',
		troubleshootLogsValue: "ioBroker Admin → onglet « Log » → filtrer par nom d'adaptateur",
		troubleshootObjectsLabel: 'État adaptateur (alive)',
		troubleshootObjectsValue: host => `Onglet Objets → system.adapter.*.0.alive (hôte : ${host})`,
