...
const translations = {
	en: {
		...
		scriptFilterHint: 'Filter by name, description, trigger type or folder',
		...
		noActiveScripts: 'No active automations configured yet.',
	...
	de: {
		...
		scriptFilterHint: 'Filtern nach Name, Beschreibung, Auslöser-Typ oder Ordner',
		...
		noActiveScripts: 'Noch keine aktiven Automatisierungen konfiguriert.',
	...
	fr: {
		...
		scriptFilterHint: 'Filtrer par nom, description, type de déclencheur ou dossier',
		...
		noActiveScripts: "Aucune automatisation active configurée pour l'instant.",
		moreScripts: '{0} scripts supplémentaires (sans description)',
		moreChanges: "modifications supplémentaires",
