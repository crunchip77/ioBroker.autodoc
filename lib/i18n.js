...
const translations = {
	en: {
		...
		aliasTarget: 'Target',
		scoreDesc:
			'The score reflects disabled adapter instances only: no disabled instances = 100%. It does not evaluate script metadata.',
		totalSuffix: 'total',
	...
	de: {
		...
		aliasTarget: 'Ziel',
		scoreDesc:
			'Der Score bezieht sich nur auf deaktivierte Adapter-Instanzen: keine deaktiviert = 100 %. Skript-Metadaten fließen nicht ein.',
		totalSuffix: 'gesamt',
	...
	fr: {
		...
		aliasTarget: 'Cible',
		scoreDesc:
			'Le score ne porte que sur les instances d’adaptateur désactivées : aucune = 100 %. Les métadonnées des scripts ne sont pas prises en compte.',
		totalSuffix: 'total',
