...
const translations = {
	en: {
		...
		aliasTarget: 'Target',
		scoreDesc: 'The score shows how complete the documentation is: all scripts labelled + all instances active = 100%.',
		total: 'total',
		...
		onboardingSetupHint: 'Tip for administrators: add a project description, contact person and notes in the adapter settings → "My Documentation".',
		...
		cronHourly: 'hourly',
		cronAt: 'at',
		cronMon: 'Mon', cronTue: 'Tue', cronWed: 'Wed', cronThu: 'Thu',
		cronFri: 'Fri', cronSat: 'Sat', cronSun: 'Sun',
	...
	de: {
		...
		aliasTarget: 'Ziel',
		scoreDesc: 'Der Score zeigt wie vollständig die Dokumentation ist: alle Skripte beschriftet + alle Instanzen aktiv = 100 %.',
		total: 'gesamt',
		...
		ramHostTooltip: 'Nur der ioBroker Host-Prozess (js-controller). Adapter-Instanzen laufen als separate Prozesse.',
		...
		onboardingSetupHint: 'Tipp für Administratoren: Projektbeschreibung, Kontaktperson und Hinweise in den Adapter-Einstellungen → „Meine Dokumentation" hinterlegen.',
		...
		cronAt: 'um',
		cronMon: 'Mo', cronTue: 'Di', cronWed: 'Mi', cronThu: 'Do',
		cronFri: 'Fr', cronSat: 'Sa', cronSun: 'So',
	...
	fr: {
		...
		aliases: 'Alias',
		aliasesDesc: 'Les alias rendent des points de données étrangers accessibles sous un nom personnalisé (alias.0.*).',
		aliasTarget: 'Cible',
		scoreDesc: 'Le score indique la complétude de la documentation : tous les scripts étiquetés + toutes les instances actives = 100 %.',
		total: 'total',
		...
		ramHostTooltip: 'Processus hôte ioBroker uniquement (js-controller). Les instances d\'adaptateurs sont des processus séparés.',
		allAdapters: 'tous les adaptateurs',
		noNotesYet: "Aucune note spéciale n'a encore été ajoutée pour cette maison intelligente. N'hésitez pas à explorer!",
		onboardingSetupHint: 'Conseil pour les administrateurs : ajoutez une description, un contact et des notes dans les paramètres de l\'adaptateur → « Ma documentation ».',
		...
		cronAt: 'à',
		cronMon: 'Lun', cronTue: 'Mar', cronWed: 'Mer', cronThu: 'Jeu',
		cronFri: 'Ven', cronSat: 'Sam', cronSun: 'Dim',
