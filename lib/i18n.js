...
const translations = {
	en: {
		...
		troubleshootingGenericDisclaimer:
			'Below are general tips for common issues. Nothing here is verified automatically against your running system — use as a checklist and confirm in Admin (log, states, files).',
	...
	de: {
		...
		troubleshootingGenericDisclaimer:
			'Die folgenden Punkte sind allgemeine Hinweise zu typischen Problemen. Sie werden nicht automatisch gegen Ihre laufende Installation geprüft — bitte als Checkliste nutzen und in Admin verifizieren (Log, States, Dateien).',
	...
	fr: {
		...
		troubleshootingGenericDisclaimer:
			'Il s’agit de conseils généraux pour des cas fréquents. Rien n’est vérifié automatiquement sur votre installation en cours — à utiliser comme liste de contrôle et à confirmer dans l’Admin (log, états, fichiers).',
