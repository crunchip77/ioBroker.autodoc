...
/**
 * @param {string|undefined} type ioBroker object type
 * @returns {number} Ranking for object display-name candidates
 */
function typeRank(type) {
	switch (type) {
		case 'device':
			return TYPE_RANK.device;
		case 'channel':
			return TYPE_RANK.channel;
		case 'state':
			return TYPE_RANK.state;
		case 'meta':
			return TYPE_RANK.meta;
		default:
			return 9;
	}
}
