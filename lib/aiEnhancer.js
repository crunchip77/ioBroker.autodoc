...
const GERMAN_ONBOARDING_POLISH_SYSTEM =
	'Du bist deutscher Lektor für Gästetexte. Du änderst nur Anrede, Grammatik und holprige Formulierungen. Du erfindest keine neuen Fakten und keine neuen Produktnamen. Themenfremde oder unsinnige Stichpunkte (z. B. Autobahnverkehr, Fernsehen, Nachrichten) streichen oder durch einen sachlichen Gast-Hinweis zu diesem Zuhause ersetzen — nicht stehen lassen. "Wohnern" → "Bewohnern". Ausgabe immer exakt mit den Überschriften NARRATIVE: und RECOMMENDATIONS: wie vorgegeben.';
...
4) Keine neuen Fakten, keine neuen Markennamen; Text nicht künstlich verlängern.
